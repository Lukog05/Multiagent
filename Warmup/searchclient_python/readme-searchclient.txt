...
Use this when running instead (cd to Warmup): java -jar server.jar -l levels/SAD1.lvl -c "python -m searchclient.searchclient" -g -s 150 -t 180
...
Use this when running instead (cd to Warmup): java -jar server.jar -l levels/SAD1.lvl -c "python -m searchclient.searchclient -dfs" -g -s 150 -t 180
...
Activate conda env 02285
cd to Warmup/searchclient_python
java -jar ../server.jar -l ../levels/MAPF00.lvl -c "python -m searchclient.searchclient" -g -s 150 -t 180